...
xgb_model <- readRDS("~/Documents/MSA_Predict_App/xgb_tuned.rds")

dummy <- readRDS("~/Documents/MSA_Predict_App/dummy.rds")

# Load the saved feature names
feature_names <- readRDS("~/Documents/MSA_Predict_App/feature_names.rds")
